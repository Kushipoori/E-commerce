...
import { loadProductsAction } from './action/productsAction';
import {
...
class Home extends Component {
  ...
  render() {
    const {
      localeData, themeData, productsData, cartData, addToCart, deleteItem, updateCart
    } = this.props;
    ...
    return (
      ...
      <div>
        <button type="button" onClick={() => { this.props.changeTheme('dark'); }}>Change Theme</button>
        <button type="button" onClick={() => { this.props.changeLocale('fr'); }}>Change Locale</button>
